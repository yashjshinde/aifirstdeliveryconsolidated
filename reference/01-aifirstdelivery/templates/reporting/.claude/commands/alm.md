...
**Single item (inline):**
```
/alm sync sales-dashboard sales-dashboard-T-001 12345
```

**Bulk file** (sent by the ALM Agent after creating all work items):
```
/alm sync sales-dashboard --file output/sales-dashboard/alm/alm-response.json
```
...
Example: `/alm sync-testplan sales-dashboard TC-SALES-DA-001 12345`
