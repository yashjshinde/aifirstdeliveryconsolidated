...
- Every ALM-provided L3 (`source: alm`) must map to at least one FR-NNN in §14 ALM Traceability Matrix — pending placeholders (`source: pending`) are exempt; FR-NNN will be generated by `/plan`
