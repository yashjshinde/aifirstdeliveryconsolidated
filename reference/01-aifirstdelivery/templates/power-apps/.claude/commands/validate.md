...
ACTION: Fix {L4-Prefix}-002, re-run /validate, then proceed with /implement {L4-Prefix}-001.
```

## Rules

- `/implement` will refuse a task unless `validation-status` = `READY TO IMPLEMENT`
