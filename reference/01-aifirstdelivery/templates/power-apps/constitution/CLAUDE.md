...
/split-spec → specs/{feature}/spec.md (power-apps-scoped)
...
/implement  → output/{feature}/src/
/document   → docs-generated/{feature}/ (app-design, flow-docs, deployment-guide, user-guide)
```
...
| `/split-spec` | review APPROVED + mixed domain detected | `specs/{f}/spec.md` (power-apps-scoped) + `specs/{f}-integration/spec.md` (if INT FRs) + `specs/{f}-data-migration/spec.md` (if DM FRs) + `specs/{f}/split-manifest.md` |
