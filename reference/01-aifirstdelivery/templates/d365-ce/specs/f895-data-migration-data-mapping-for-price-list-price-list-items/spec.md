---
feature: f895-data-migration-data-mapping-for-price-list-price-list-items
date: 2026-05-08
status: DRAFT
intake: structured
l3-intake: optional
...
alm-ids:
  ...
  L2:
    - id: "895"
      title: "Data Migration - Data Mapping for - Price list, Price List Items"
  L3:
    - id: "(pending)"
...
# Functional Specification — Data Migration - Data Mapping for - Price list, Price List Items

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 460 — E07-System Configurations
> **Feature ALM ID:** 895 (state: New)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review

> **⚠ Multi-domain alert.** This feature contains signals that the d365-ce constitution treats as out-of-domain. `/review` will raise this as a BLOCKER per `constitution/14-field-service-deprecations-and-integration.md` and the broader multi-domain rule. Run `/split-spec f895-...` after /review to route the integration / data-migration portions to the appropriate agent.


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 895) under its parent Epic (460). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
### In Scope
- ALM Feature **895 — Data Migration - Data Mapping for - Price list, Price List Items** (the entirety of this single feature, as described in §5).
...
#### Feature: 895 — Data Migration - Data Mapping for - Price list, Price List Items
...
**ALM ID:** *(pending)*
**Parent L2:** 895 — Data Migration - Data Mapping for - Price list, Price List Items
...
- ALM IDs are immutable — this feature retains ALM ID **895** and parent Epic **460**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 895 | Spec Agent | Open |
...
**L2-895 — Data Migration - Data Mapping for - Price list, Price List Items**
- See attached mapping file links and design links (Ajay to provide)
- Avanade to provide the target file(s)
- OPEX team to enter source columns against the target columns
- OPEX and Avanade team will review the mapping and finalize,
...
|---|---|---|---|---|---|---|
| 460 | 895 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
