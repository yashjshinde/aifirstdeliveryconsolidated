...
alm-ids:
  ...
  L2:
    - id: "485"
      title: "Asset Management - Customer Asset 360 View"
  L3:
    - id: "(pending)"
...
# Functional Specification — Asset Management - Customer Asset 360 View

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 454 — E01-Customer Management
> **Feature ALM ID:** 485 (state: Ready)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 485) under its parent Epic (454). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
**Business Objective:**
Deliver the capability described in ALM Feature **485 — Asset Management - Customer Asset 360 View** within the broader Epic 454 (E01-Customer Management). The capability is documented verbatim in §5; this section paraphrases the intent only — no requirements are introduced beyond the ALM source.
...
### In Scope
- ALM Feature **485 — Asset Management - Customer Asset 360 View** (the entirety of this single feature, as described in §5).
...
**ALM ID:** *(pending)*
**Parent L2:** 485 — Asset Management - Customer Asset 360 View
...
| Table | `msdyn_agreement` | Modified | Surface in 360 / form layout for this feature. |
...
- ALM IDs are immutable — this feature retains ALM ID **485** and parent Epic **454**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 485 | Spec Agent | Open |
...
**L2-485 — Asset Management - Customer Asset 360 View**
AC:1
...
|---|---|---|---|---|---|---|
| 454 | 485 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
