...
alm-ids:
  ...
  L2:
    - id: "466"
      title: "Account Management - Bill‑To to Ship‑To Relationship"
  L3:
    - id: "(pending)"
...
# Functional Specification — Account Management - Bill‑To to Ship‑To Relationship

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 454 — E01-Customer Management
> **Feature ALM ID:** 466 (state: Refinement)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 466) under its parent Epic (454). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
**Business Objective:**
Deliver the capability described in ALM Feature **466 — Account Management - Bill‑To to Ship‑To Relationship** within the broader Epic 454 (E01-Customer Management). The capability is documented verbatim in §5; this section paraphrases the intent only — no requirements are introduced beyond the ALM source.
...
### In Scope
- ALM Feature **466 — Account Management - Bill‑To to Ship‑To Relationship** (the entirety of this single feature, as described in §5).
...
**ALM ID:** *(pending)*
**Parent L2:** 466 — Account Management - Bill‑To to Ship‑To Relationship
...
| Table | `msdyn_customerasset` | Modified | Surface in 360 / form layout for this feature. |
...
- ALM IDs are immutable — this feature retains ALM ID **466** and parent Epic **454**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 466 | Spec Agent | Open |
...
**L2-466 — Account Management - Bill‑To to Ship‑To Relationship**
AC-1:
Given a bill‑to is linked to multiple ship‑tos in Fusion,
When synced with D365 ,
Then an equivalent relationship will be represented in D365 where one or more ship to (service account) is linked to a Bill to (billing account).
...
|---|---|---|---|---|---|---|
| 454 | 466 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
