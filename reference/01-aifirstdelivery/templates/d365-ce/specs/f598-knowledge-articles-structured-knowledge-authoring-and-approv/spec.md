...
alm-ids:
  L1:
    - id: "459"
      title: "E06- Knowledge Base"
  L2:
    - id: "598"
      title: "Knowledge Articles - Structured Knowledge Authoring and Approval Workflow"
  L3:
    - id: "(pending)"
...
# Functional Specification — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 459 — E06-Knowledge Base
> **Feature ALM ID:** 598 (state: Ready)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 598) under its parent Epic (459). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
**Business Objective:**
Deliver the capability described in ALM Feature **598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow** within the broader Epic 459 (E06-Knowledge Base). The capability is documented verbatim in §5; this section paraphrases the intent only — no requirements are introduced beyond the ALM source.
...
### In Scope
- ALM Feature **598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow** (the entirety of this single feature, as described in §5).

### Out of Scope
- All sibling features under Epic 459 (E06-Knowledge Base) — they have their own per-feature specs.
...
|---|---|---|
| knowledge contributor | Persona derived from feature description. | TBD (custom Service role expected) |
...
**ALM ID:** *(pending)*
**Parent L2:** 598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow
...
|---|---|---|---|
| Table | `knowledgearticle` | Modified | Surface in 360 / form layout for this feature. |
...
- ALM IDs are immutable — this feature retains ALM ID **598** and parent Epic **459**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 598 | Spec Agent | Open |
...
**L2-598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow**
AC‑1
...
|---|---|---|---|
| 1.0 | 2026-05-08 | Claude Code (/spec-alm) | Per-feature slice generated from `tools/alm-agent/output/wi-export-features-20260508.json`. Parent Epic: 459 (E06-Knowledge Base). L3 deferred to /plan. |
...
|---|---|---|---|---|---|---|
| 459 | 598 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
