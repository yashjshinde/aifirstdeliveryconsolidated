...
alm-ids:
  ...
  L2:
    - id: "465"
      title: "Account Management - Informational Parent Hierarchy in D365"
  L3:
    - id: "(pending)"
...
# Functional Specification — Account Management - Informational Parent Hierarchy in D365

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 454 — E01-Customer Management
> **Feature ALM ID:** 465 (state: Refinement)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 465) under its parent Epic (454). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
**Business Objective:**
Deliver the capability described in ALM Feature **465 — Account Management - Informational Parent Hierarchy in D365** within the broader Epic 454 (E01-Customer Management). The capability is documented verbatim in §5; this section paraphrases the intent only — no requirements are introduced beyond the ALM source.
...
### In Scope
- ALM Feature **465 — Account Management - Informational Parent Hierarchy in D365** (the entirety of this single feature, as described in §5).
...
**ALM ID:** *(pending)*
**Parent L2:** 465 — Account Management - Informational Parent Hierarchy in D365
...
- ALM IDs are immutable — this feature retains ALM ID **465** and parent Epic **454**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 465 | Spec Agent | Open |
...
**L2-465 — Account Management - Informational Parent Hierarchy in D365**
AC-1:
Given multiple service accounts belong to one organization,
When viewed in D365,
Then hierarchy is in place on Accounts for the user to be able to add a relation between two accounts.
...
|---|---|---|---|---|---|---|
| 454 | 465 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
