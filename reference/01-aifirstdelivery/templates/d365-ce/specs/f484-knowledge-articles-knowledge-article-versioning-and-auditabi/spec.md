...
alm-ids:
  ...
  L2:
    - id: "484"
      title: "Knowledge Articles - Knowledge Article Versioning and Auditability"
  L3:
    - id: "(pending)"
...
# Functional Specification — Knowledge Articles - Knowledge Article Versioning and Auditability

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 459 — E06-Knowledge Base
> **Feature ALM ID:** 484 (state: Ready)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 484) under its parent Epic (459). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
**Business Objective:**
Deliver the capability described in ALM Feature **484 — Knowledge Articles - Knowledge Article Versioning and Auditability** within the broader Epic 459 (E06-Knowledge Base). The capability is documented verbatim in §5; this section paraphrases the intent only — no requirements are introduced beyond the ALM source.
...
### In Scope
- ALM Feature **484 — Knowledge Articles - Knowledge Article Versioning and Auditability** (the entirety of this single feature, as described in §5).
...
|---|---|---|
| knowledge owner | Persona derived from feature description. | TBD (custom Service role expected) |
...
**ALM ID:** *(pending)*
**Parent L2:** 484 — Knowledge Articles - Knowledge Article Versioning and Auditability
...
- ALM IDs are immutable — this feature retains ALM ID **484** and parent Epic **459**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 484 | Spec Agent | Open |
...
**L2-484 — Knowledge Articles - Knowledge Article Versioning and Auditability**
AC‑1
...
|---|---|---|---|---|---|---|
| 459 | 484 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
