---
feature: f897-data-migration-data-mapping-for-territory-region-data-and-re
date: 2026-05-08
status: DRAFT
intake: structured
l3-intake: optional
...
alm-ids:
  ...
  L2:
    - id: "897"
      title: "Data Migration - Data Mapping for - Territory (Region) data and related tables"
  L3:
    - id: "(pending)"
...
# Functional Specification — Data Migration - Data Mapping for - Territory (Region) data and related tables

> **Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
> **Parent Epic:** 460 — E07-System Configurations
> **Feature ALM ID:** 897 (state: New)
> **Intake Mode:** Structured — single-feature slice enhanced from ALM
> **Version:** 1.0
> **Status:** Draft for Review

> **⚠ Multi-domain alert.** This feature contains signals that the d365-ce constitution treats as out-of-domain. `/review` will raise this as a BLOCKER per `constitution/14-field-service-deprecations-and-integration.md` and the broader multi-domain rule. Run `/split-spec f897-...` after /review to route the integration / data-migration portions to the appropriate agent.


This is a **per-feature** specification slice. It contains exactly one L2 (Feature 897) under its parent Epic (460). The L3 layer is pending — /plan will decompose this feature into Product Backlog Item stories and Tasks.
...
### In Scope
- ALM Feature **897 — Data Migration - Data Mapping for - Territory (Region) data and related tables** (the entirety of this single feature, as described in §5).
...
#### Feature: 897 — Data Migration - Data Mapping for - Territory (Region) data and related tables
...
Territory and Zip codes have native mapping with D365 (same table names)

While mapping consider territory hierarchy

Zip code values may just be excel import without needing automation.

Ignore employee associated with Territory in this work item, that must be considered for "employee" related work item
...
**ALM ID:** *(pending)*
**Parent L2:** 897 — Data Migration - Data Mapping for - Territory (Region) data and related tables
...
- ALM IDs are immutable — this feature retains ALM ID **897** and parent Epic **460**.
...
|---|---|---|---|---|
| Q-001 | None flagged in ALM source — confirm during /review. | 897 | Spec Agent | Open |
...
**L2-897 — Data Migration - Data Mapping for - Territory (Region) data and related tables**
- See attached mapping file links and design links (Ajay to provide)
- Avanade to provide the target file(s)
- OPEX team to enter source columns against the target columns
- OPEX and Avanade team will review the mapping and finalize,
...
|---|---|---|---|---|---|---|
| 460 | 897 | *(pending)* | *(to be defined in /plan)* | pending | — | — |
