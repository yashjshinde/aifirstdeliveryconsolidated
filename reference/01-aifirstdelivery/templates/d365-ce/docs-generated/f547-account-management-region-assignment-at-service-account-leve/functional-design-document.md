...
# Functional Design Document — Account Management - Region Assignment at service Account Level

**Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
**Based On:** Functional Specification v1.0 — see [spec.md](../../specs/f547-account-management-region-assignment-at-service-account-leve/spec.md)
...
|---|---|---|
| Functional Specification | 1.0 | [spec.md](../../specs/f547-account-management-region-assignment-at-service-account-leve/spec.md) |
| Spec Review | 1.1 | [review.md](../../specs/f547-account-management-region-assignment-at-service-account-leve/review.md) |
...
This Functional Design Document is the authoritative reference for build, configuration, and User Acceptance Testing (UAT) of **Account Management - Region Assignment at service Account Level** within the broader Epic 454 (E01-Customer Management). It is intended for developers, testers, and business stakeholders. The FDD elaborates the approved functional specification at [spec.md](../../specs/f547-account-management-region-assignment-at-service-account-leve/spec.md) into structured design content; it does not introduce new requirements. Where the upstream specification was authored under `l3-intake: optional` (FRs deferred to `/plan`), this FDD carries that deferral forward and flags impacted sections in §16 Functional Gap Log.

### 2.2 Scope

This document covers the design for ALM Feature **547 — Account Management - Region Assignment at service Account Level** under Epic 454 (E01-Customer Management). The capability is delivered as a single module:

- **Module 1:** Account Management - Region Assignment at service Account Level — see §6.1.

Cross-references: see [spec.md](../../specs/f547-account-management-region-assignment-at-service-account-leve/spec.md) §5 for the verbatim ALM description and acceptance criteria. FR-NNN range will be assigned by `/plan` from the L3 Product Backlog Item created at that step.
...
|---|---|---|
| Customer Manager | Maintains/curates Account/Contact data and views in D365. | Module 1 |
...
|---|---|---|
| L3 Product Backlog Item created in ADO under Feature 547 | Generated by `/plan` | FR-NNN can be authored |
...
**To-Be (Future State):** Account Management - Region Assignment at service Account Level delivers the capability described in the spec to give service users the consolidated view / control they need within D365 CE, leveraging records synced from Fusion and any D365-native informational data added by this feature.
...
| CE-002 | `territory` | Extension | Custom Column on existing entity | `territory` | Simple | TBD (deferred to /plan) | Surface in 360 / form layout for this feature. |
...
### 6.1 Module: Account Management - Region Assignment at service Account Level

#### 6.1.1 Module Overview

This module covers the entirety of ALM Feature **547 — Account Management - Region Assignment at service Account Level**. It is a single-feature module in this FDD; sibling features under Epic 454 are scoped in their own per-feature FDDs. The module's primary personas are listed in §3.2; dependencies are documented in §3.4 and §14.2.
...
| Table | `territory` | Surface in 360 / form layout for this feature. | D365-native | D365-native |
