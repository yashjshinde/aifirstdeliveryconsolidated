...
# Functional Design Document — Activity Management - Manual Creation of Emails and Phone calls

**Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
**Based On:** Functional Specification v1.0 — see [spec.md](../../specs/f719-activity-management-manual-creation-of-emails-and-phone-call/spec.md)
...
|---|---|---|
| Functional Specification | 1.0 | [spec.md](../../specs/f719-activity-management-manual-creation-of-emails-and-phone-call/spec.md) |
| Spec Review | 1.1 | [review.md](../../specs/f719-activity-management-manual-creation-of-emails-and-phone-call/review.md) |
...
This Functional Design Document is the authoritative reference for build, configuration, and User Acceptance Testing (UAT) of **Activity Management - Manual Creation of Emails and Phone calls** within the broader Epic 454 (E01-Customer Management). It is intended for developers, testers, and business stakeholders. The FDD elaborates the approved functional specification at [spec.md](../../specs/f719-activity-management-manual-creation-of-emails-and-phone-call/spec.md) into structured design content; it does not introduce new requirements. Where the upstream specification was authored under `l3-intake: optional` (FRs deferred to `/plan`), this FDD carries that deferral forward and flags impacted sections in §16 Functional Gap Log.

### 2.2 Scope

This document covers the design for ALM Feature **719 — Activity Management - Manual Creation of Emails and Phone calls** under Epic 454 (E01-Customer Management). The capability is delivered as a single module:

- **Module 1:** Activity Management - Manual Creation of Emails and Phone calls — see §6.1.

Cross-references: see [spec.md](../../specs/f719-activity-management-manual-creation-of-emails-and-phone-call/spec.md) §5 for the verbatim ALM description and acceptance criteria. FR-NNN range will be assigned by `/plan` from the L3 Product Backlog Item created at that step.
...
|---|---|---|
| D365 user | Service-side user creating/viewing records. | Module 1 |
...
|---|---|---|
| L3 Product Backlog Item created in ADO under Feature 719 | Generated by `/plan` | FR-NNN can be authored |
...
**To-Be (Future State):** Activity Management - Manual Creation of Emails and Phone calls delivers the capability described in the spec to give service users the consolidated view / control they need within D365 CE, leveraging records synced from Fusion and any D365-native informational data added by this feature.
...
|---|---|---|---|---|---|---|---|
| CE-001 | `email` | Extension | Custom Column on existing entity | `email` | Simple | TBD (deferred to /plan) | Surface in 360 / form layout for this feature. |
| CE-002 | `phonecall` | Extension | Custom Column on existing entity | `phonecall` | Simple | TBD (deferred to /plan) | Surface in 360 / form layout for this feature. |
...
|---|---|---|---|---|
| Table | `email` | Surface in 360 / form layout for this feature. | D365-native | D365-native |
| Table | `phonecall` | Surface in 360 / form layout for this feature. | D365-native | D365-native |
...
| FG-004 | Open spec question carried forward: TBD in ALM source: `TBD - Phone call` | Medium | Medium | Spec author / Business Owner | TBD | Open |
| FG-005 | Open spec question carried forward: TBD in ALM source: `TBD - Email` | Medium | Medium | Spec author / Business Owner | TBD | Open |
