...
# Functional Design Document — Knowledge Articles - Knowledge Article Versioning and Auditability

**Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
**Based On:** Functional Specification v1.0 — see [spec.md](../../specs/f484-knowledge-articles-knowledge-article-versioning-and-auditabi/spec.md)
...
|---|---|---|
| Functional Specification | 1.0 | [spec.md](../../specs/f484-knowledge-articles-knowledge-article-versioning-and-auditabi/spec.md) |
| Spec Review | 1.1 | [review.md](../../specs/f484-knowledge-articles-knowledge-article-versioning-and-auditabi/review.md) |
...
This Functional Design Document is the authoritative reference for build, configuration, and User Acceptance Testing (UAT) of **Knowledge Articles - Knowledge Article Versioning and Auditability** within the broader Epic 459 (E06- Knowledge Base). It is intended for developers, testers, and business stakeholders. The FDD elaborates the approved functional specification at [spec.md](../../specs/f484-knowledge-articles-knowledge-article-versioning-and-auditabi/spec.md) into structured design content; it does not introduce new requirements. Where the upstream specification was authored under `l3-intake: optional` (FRs deferred to `/plan`), this FDD carries that deferral forward and flags impacted sections in §16 Functional Gap Log.

### 2.2 Scope

This document covers the design for ALM Feature **484 — Knowledge Articles - Knowledge Article Versioning and Auditability** under Epic 459 (E06- Knowledge Base). The capability is delivered as a single module:

- **Module 1:** Knowledge Articles - Knowledge Article Versioning and Auditability — see §6.1.

Cross-references: see [spec.md](../../specs/f484-knowledge-articles-knowledge-article-versioning-and-auditabi/spec.md) §5 for the verbatim ALM description and acceptance criteria. FR-NNN range will be assigned by `/plan` from the L3 Product Backlog Item created at that step.
...
|---|---|---|
| knowledge owner | Persona derived from feature description. | Module 1 |
...
|---|---|---|
| L3 Product Backlog Item created in ADO under Feature 484 | Generated by `/plan` | FR-NNN can be authored |
...
**To-Be (Future State):** Knowledge Articles - Knowledge Article Versioning and Auditability delivers the capability described in the spec to give service users the consolidated view / control they need within D365 CE, leveraging records synced from Fusion and any D365-native informational data added by this feature.
...
### 6.1 Module: Knowledge Articles - Knowledge Article Versioning and Auditability

#### 6.1.1 Module Overview

This module covers the entirety of ALM Feature **484 — Knowledge Articles - Knowledge Article Versioning and Auditability**. It is a single-feature module in this FDD; sibling features under Epic 459 are scoped in their own per-feature FDDs. The module's primary personas are listed in §3.2; dependencies are documented in §3.4 and §14.2.
...
#### Feature: 484 — Knowledge Articles - Knowledge Article Versioning and Auditability
...
I want version history for articles
...
Given a knowledge article is updated,

When a user views article details

Then the last updated date and version information are visible.



AC‑2

Given an article has been revised multiple times,

When an administrator reviews the article,

Then prior versions can be identified for audit or reference purposes.



Technical Notes:

- D365 KB article record form will show Modified data (this is the last updated date) and major and minor versions. This along with the "published" status supports versioning and auditing. This is native functionality.
- On the summary tab of the LB article the grid "related versions" will show all previous versions.
- Outcome of this story - Document (copy from learn) with screenshot so that OPEX user can get this info in the document.
