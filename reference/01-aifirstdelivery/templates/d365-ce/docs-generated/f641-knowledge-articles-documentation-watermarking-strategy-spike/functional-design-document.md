...
# Functional Design Document — Knowledge Articles - Documentation Watermarking Strategy - SPIKE

**Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
**Based On:** Functional Specification v1.0 — see [spec.md](../../specs/f641-knowledge-articles-documentation-watermarking-strategy-spike/spec.md)
...
|---|---|---|
| Functional Specification | 1.0 | [spec.md](../../specs/f641-knowledge-articles-documentation-watermarking-strategy-spike/spec.md) |
| Spec Review | 1.1 | [review.md](../../specs/f641-knowledge-articles-documentation-watermarking-strategy-spike/review.md) |
...
This Functional Design Document is the authoritative reference for build, configuration, and User Acceptance Testing (UAT) of **Knowledge Articles - Documentation Watermarking Strategy - SPIKE** within the broader Epic 459 (E06- Knowledge Base). It is intended for developers, testers, and business stakeholders. The FDD elaborates the approved functional specification at [spec.md](../../specs/f641-knowledge-articles-documentation-watermarking-strategy-spike/spec.md) into structured design content; it does not introduce new requirements. Where the upstream specification was authored under `l3-intake: optional` (FRs deferred to `/plan`), this FDD carries that deferral forward and flags impacted sections in §16 Functional Gap Log.

### 2.2 Scope

This document covers the design for ALM Feature **641 — Knowledge Articles - Documentation Watermarking Strategy - SPIKE** under Epic 459 (E06- Knowledge Base). The capability is delivered as a single module:

- **Module 1:** Knowledge Articles - Documentation Watermarking Strategy - SPIKE — see §6.1.

Cross-references: see [spec.md](../../specs/f641-knowledge-articles-documentation-watermarking-strategy-spike/spec.md) §5 for the verbatim ALM description and acceptance criteria. FR-NNN range will be assigned by `/plan` from the L3 Product Backlog Item created at that step.
...
|---|---|---|
| L3 Product Backlog Item created in ADO under Feature 641 | Generated by `/plan` | FR-NNN can be authored |
...
**To-Be (Future State):** Knowledge Articles - Documentation Watermarking Strategy - SPIKE delivers the capability described in the spec to give service users the consolidated view / control they need within D365 CE, leveraging records synced from Fusion and any D365-native informational data added by this feature.
...
|---|---|---|---|---|---|---|---|
| CE-001 | TBD | TBD | TBD | TBD | TBD | TBD (deferred to /plan) | Object inventory deferred — no FRs in source spec (l3-intake: optional). |
...
### 6.1 Module: Knowledge Articles - Documentation Watermarking Strategy - SPIKE

#### 6.1.1 Module Overview

This module covers the entirety of ALM Feature **641 — Knowledge Articles - Documentation Watermarking Strategy - SPIKE**. It is a single-feature module in this FDD; sibling features under Epic 459 are scoped in their own per-feature FDDs. The module's primary personas are listed in §3.2; dependencies are documented in §3.4 and §14.2.
...
Support a strategy to apply dynamic identity‑based watermarking when service documentation is downloaded.



TBD - Attributes related to Identity based Watermarking(e.g Name, IP address etc.)

##### Original Acceptance Criteria (verbatim from ALM)

AC1 – Controlled Download
...
GIVEN a user attempts to download service documentation from within the D365 KB article preview

WHEN the document is downloaded

THEN the downloaded articles should have the watermark on them.


AC2 – Validation Required
GIVEN watermarking is enabled

WHEN downloaded document is accessed


THEN the document should have a identity-based watermark.



Technical Notes:

- This needs a spike in sprint 1/2 to come up with an approach and decide the scope.
- Based on viable approach and confirmation with OPEX, we must proceed.
- The watermark is the logged in CRM user's name and date time.
...
|---|---|---|---|---|
| _(deferred)_ | — | Will be confirmed in /plan after FR generation. | — | — |
...
| FG-004 | Open spec question carried forward: TBD in ALM source: `TBD - Attributes related to Identity based Watermarking(e.g Name, IP address etc.)` | Medium | Medium | Spec author / Business Owner | TBD | Open |
