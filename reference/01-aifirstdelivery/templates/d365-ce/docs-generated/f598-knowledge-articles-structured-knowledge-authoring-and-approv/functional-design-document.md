...
status: DRAFT
version: 1.0
spec-ref: specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/spec.md
parent-epic-id: "459"
...
# Functional Design Document — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow

**Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
**Based On:** Functional Specification v1.0 — see [spec.md](../../specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/spec.md)
...
|---|---|---|
| Functional Specification | 1.0 | [spec.md](../../specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/spec.md) |
| Spec Review | 1.1 | [review.md](../../specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/review.md) |
...
This Functional Design Document is the authoritative reference for build, configuration, and User Acceptance Testing (UAT) of **Knowledge Articles - Structured Knowledge Authoring and Approval Workflow** within the broader Epic 459 (E06- Knowledge Base). It is intended for developers, testers, and business stakeholders. The FDD elaborates the approved functional specification at [spec.md](../../specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/spec.md) into structured design content; it does not introduce new requirements. Where the upstream specification was authored under `l3-intake: optional` (FRs deferred to `/plan`), this FDD carries that deferral forward and flags impacted sections in §16 Functional Gap Log.

### 2.2 Scope

This document covers the design for ALM Feature **598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow** under Epic 459 (E06- Knowledge Base). The capability is delivered as a single module:

- **Module 1:** Knowledge Articles - Structured Knowledge Authoring and Approval Workflow — see §6.1.

Cross-references: see [spec.md](../../specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/spec.md) §5 for the verbatim ALM description and acceptance criteria. FR-NNN range will be assigned by `/plan` from the L3 Product Backlog Item created at that step.
...
|---|---|---|
| knowledge contributor | Persona derived from feature description. | Module 1 |
...
|---|---|---|
| L3 Product Backlog Item created in ADO under Feature 598 | Generated by `/plan` | FR-NNN can be authored |
...
**To-Be (Future State):** Knowledge Articles - Structured Knowledge Authoring and Approval Workflow delivers the capability described in the spec to give service users the consolidated view / control they need within D365 CE, leveraging records synced from Fusion and any D365-native informational data added by this feature.
...
|---|---|---|---|---|---|---|---|
| CE-001 | `knowledgearticle` | Extension | Custom Column on existing entity | `knowledgearticle` | Simple | TBD (deferred to /plan) | Surface in 360 / form layout for this feature. |
...
### 6.1 Module: Knowledge Articles - Structured Knowledge Authoring and Approval Workflow

#### 6.1.1 Module Overview

This module covers the entirety of ALM Feature **598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow**. It is a single-feature module in this FDD; sibling features under Epic 459 are scoped in their own per-feature FDDs. The module's primary personas are listed in §3.2; dependencies are documented in §3.4 and §14.2.
...
#### Feature: 598 — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow
...
I want New articles or an update to the existing Article within D365 reviewed before publishing

so that content quality is consistent.
...
Given a new KB article is created in D365,

When it is submitted for publication,

Then it is reviewed by an appropriate subject matter expert before becoming visible within the search.
...
Given an KB article is published,

When technicians view the article,

Then they can provide feedback or comments on usefulness.



Note
: OOTB KB BPF will not be used. Need to remove it.



Technical Notes:

- Document knowledge article publishing process (OOB).
- Document how article can be assigned to another CRM user for review before publishing
- For the second one, document D365 feedback and comments feature so this goes for review to the Knowledge Manager before publishing.
- Remove OOB BPF as mentioned in the acceptance criteria.
...
|---|---|---|---|---|
| Table | `knowledgearticle` | Surface in 360 / form layout for this feature. | D365-native | D365-native |
...
|---|---|---|
| 1 | Sibling features under Epic 459 | Each has its own per-feature FDD |
