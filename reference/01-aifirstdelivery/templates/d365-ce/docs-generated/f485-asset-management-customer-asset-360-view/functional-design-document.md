...
status: DRAFT
version: 1.0
spec-ref: specs/f485-asset-management-customer-asset-360-view/spec.md
parent-epic-id: "454"
...
# Functional Design Document — Asset Management - Customer Asset 360 View

**Project:** IS - D365 Avanade — Service Operations on Dynamics 365 CE
**Based On:** Functional Specification v1.0 — see [spec.md](../../specs/f485-asset-management-customer-asset-360-view/spec.md)
...
|---|---|---|
| Functional Specification | 1.0 | [spec.md](../../specs/f485-asset-management-customer-asset-360-view/spec.md) |
| Spec Review | 1.1 | [review.md](../../specs/f485-asset-management-customer-asset-360-view/review.md) |
...
This Functional Design Document is the authoritative reference for build, configuration, and User Acceptance Testing (UAT) of **Asset Management - Customer Asset 360 View** within the broader Epic 454 (E01-Customer Management). It is intended for developers, testers, and business stakeholders. The FDD elaborates the approved functional specification at [spec.md](../../specs/f485-asset-management-customer-asset-360-view/spec.md) into structured design content; it does not introduce new requirements. Where the upstream specification was authored under `l3-intake: optional` (FRs deferred to `/plan`), this FDD carries that deferral forward and flags impacted sections in §16 Functional Gap Log.

### 2.2 Scope

This document covers the design for ALM Feature **485 — Asset Management - Customer Asset 360 View** under Epic 454 (E01-Customer Management). The capability is delivered as a single module:

- **Module 1:** Asset Management - Customer Asset 360 View — see §6.1.

Cross-references: see [spec.md](../../specs/f485-asset-management-customer-asset-360-view/spec.md) §5 for the verbatim ALM description and acceptance criteria. FR-NNN range will be assigned by `/plan` from the L3 Product Backlog Item created at that step.
...
|---|---|---|
| L3 Product Backlog Item created in ADO under Feature 485 | Generated by `/plan` | FR-NNN can be authored |
...
**To-Be (Future State):** Asset Management - Customer Asset 360 View delivers the capability described in the spec to give service users the consolidated view / control they need within D365 CE, leveraging records synced from Fusion and any D365-native informational data added by this feature.
...
| CE-003 | `msdyn_customerasset` | Extension | Custom Column on existing entity | `msdyn_customerasset` | Simple | TBD (deferred to /plan) | Surface in 360 / form layout for this feature. |
...
| CE-005 | `knowledgearticle` | Extension | Custom Column on existing entity | `knowledgearticle` | Simple | TBD (deferred to /plan) | Surface in 360 / form layout for this feature. |
...
### 6.1 Module: Asset Management - Customer Asset 360 View

#### 6.1.1 Module Overview

This module covers the entirety of ALM Feature **485 — Asset Management - Customer Asset 360 View**. It is a single-feature module in this FDD; sibling features under Epic 454 are scoped in their own per-feature FDDs. The module's primary personas are listed in §3.2; dependencies are documented in §3.4 and §14.2.
...
#### Feature: 485 — Asset Management - Customer Asset 360 View
...
I want all the Associated records (Sub Assets, Accounts, Functional Locations, Linked Knowledge Articles, Work Orders, Agreement booking incident) tied to Customer Asset Record


So that Customer Asset 360 View is available when viewed in D365.

##### Original Acceptance Criteria (verbatim from ALM)

AC:1

Given a Customer Asset exists in D365,


When viewed in D365,


Then the Customer Asset form should show all the Associated records in respective grids/tabs as per the expected layout.
...
- Remove unnecessary items from related record sitemap if applicable during review
