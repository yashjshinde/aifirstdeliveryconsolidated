...
parent-epic-id: "454"
feature-alm-id: "467"
plan-ref: plans/f467-account-management-account-360-view/plan.md
spec-ref: specs/f467-account-management-account-360-view/spec.md
---

# Plan Clarification Report — Account Management - Account 360 View
...
|---|---|---|---|
| T-001 | Clone `Account — Main` form and configure 360 layout (tabs + sub-grids) | QUESTION | See Questions section |
| T-002 | Add sub-grids: Contacts, Agreements, Customer Assets, Functional Locations, Cases, Work Orders, Invoices | QUESTION | See Questions section |
| T-003 | Configure Field Security Profile for cost / PII columns on Account | READY | — |
...
- `/tdd f467-account-management-account-360-view` — should answer the schema-detail QUESTIONs.
- `/task f467-account-management-account-360-view` — generates cards; QUESTIONs are embedded as caveats.
