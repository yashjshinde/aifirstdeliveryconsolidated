...
parent-epic-id: "459"
feature-alm-id: "598"
plan-ref: plans/f598-knowledge-articles-structured-knowledge-authoring-and-approv/plan.md
spec-ref: specs/f598-knowledge-articles-structured-knowledge-authoring-and-approv/spec.md
---

# Plan Clarification Report — Knowledge Articles - Structured Knowledge Authoring and Approval Workflow
...
- `/tdd f598-knowledge-articles-structured-knowledge-authoring-and-approv` — should answer the schema-detail QUESTIONs.
- `/task f598-knowledge-articles-structured-knowledge-authoring-and-approv` — generates cards; QUESTIONs are embedded as caveats.
