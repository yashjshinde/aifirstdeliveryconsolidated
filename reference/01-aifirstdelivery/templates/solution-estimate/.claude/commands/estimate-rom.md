...
| Confidence | Low — L4/L5 requirements; estimate refines after `/estimate-spec` (±20%) or `/estimate-plan` (±10%) |
...
- **Proposed by**: /estimate-rom {project}
