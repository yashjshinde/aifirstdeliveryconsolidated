...
```
/estimate-rollup {project}
```

## Pre-condition Check

1. Check `estimates/{project}/module-overall-hrs.md` exists.
   If not: "No built estimate found. Run `/estimate-build {project}` first."
