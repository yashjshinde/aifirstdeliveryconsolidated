...
/solution-blueprint {project-name} --features d365-ce:{f1},d365-fo:{f2},integration:{f3},power-apps:{f4}
```
...
Next steps:
  /solution-review {project-name}  ← validate the blueprint against the constitution
```
