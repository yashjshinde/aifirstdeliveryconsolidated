---
mode: agent
description: "Generate a Data Migration specification — direction, entities, field scope, data quality rules, error handling. Triggers on: 'spec', 'migration spec', 'write spec'."
---
...
```
/data-migration-spec {migration-id}
```
