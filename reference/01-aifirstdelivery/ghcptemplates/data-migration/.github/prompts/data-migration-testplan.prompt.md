---
mode: agent
description: "Generate a Data Migration test plan and test cases. Triggers on: 'testplan', 'test plan', 'migration test strategy'."
---
...
```
/data-migration-testplan {migration-id}
```
...
Next step: /data-migration-plan {migration-id}
```
