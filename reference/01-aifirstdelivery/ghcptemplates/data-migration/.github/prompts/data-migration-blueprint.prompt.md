---
mode: agent
description: "Generate a Data Migration solution blueprint. Triggers on: 'blueprint', 'solution blueprint'."
---
...
```
/data-migration-blueprint {migration-id}
```
...
Pre-implementation checklist (the same checklist validated by `/data-migration-validate`):
...
Next step: /data-migration-task {migration-id}
```
