---
mode: agent
description: "Generate dev-ready task cards from the data migration plan for each work item. Triggers on: 'task', 'generate task cards', 'task cards'."
---
...
```
/data-migration-task {migration-id}
```
...
Next step: /data-migration-validate {migration-id}
```
