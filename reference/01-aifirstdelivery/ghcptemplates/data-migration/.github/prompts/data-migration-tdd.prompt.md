---
mode: agent
description: "Generate the Technical Design Document for a data migration covering ADF, SQL, and security design. Triggers on: 'tdd', 'technical design', 'design document'."
---
...
```
/data-migration-tdd {migration-id}
```
...
Next step: /data-migration-blueprint {migration-id}
```
