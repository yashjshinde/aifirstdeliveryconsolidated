---
mode: agent
description: "Validate all data migration task cards for implementation readiness and set validation status. Triggers on: 'validate', 'validation', 'ready to implement'."
---
...
```
/data-migration-validate {migration-id}
```
...
Next step: /data-migration-implement {migration-id}
```

**GATE:** `/data-migration-implement` may not run until ALL tasks are **READY TO IMPLEMENT**.
