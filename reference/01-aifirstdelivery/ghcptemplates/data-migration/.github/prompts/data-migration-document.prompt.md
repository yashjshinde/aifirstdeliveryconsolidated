---
mode: agent
description: "Generate Data Migration operational documentation — deployment guide, runbook, release notes. Triggers on: 'document', 'operational docs', 'deployment guide'."
---
...
```
/data-migration-document {migration-id}
```

## Pre-condition

`/data-migration-implement {migration-id}` must be complete (all task cards marked IMPLEMENTED).
