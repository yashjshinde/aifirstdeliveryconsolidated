---
mode: agent
description: "Generate a detailed estimate (±10% confidence) from an approved plan. Triggers on: 'estimate-plan', 'detailed estimate'."
---
...
```
/solution-estimate-estimate-plan {project} {feature}
```
