---
mode: agent
description: "Generate a D365 F&O Functional Design Specification (FDD) from business requirements. Triggers on: 'fdd', 'functional design', 'write fdd'."
---
...
Next step: /d365-fo-fdd-review {requirement-name}
```
