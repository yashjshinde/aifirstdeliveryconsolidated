---
mode: agent
description: "Generate a D365 F&O Technical Design Specification (TDD/TDS) from an approved FDD. Triggers on: 'tdd', 'technical design', 'write tdd'."
---
...
Run /d365-fo-fdd-review {requirement-name} and resolve all BLOCKERs before generating the TDD.
```
...
Next step: /d365-fo-tdd-review {requirement-name}
```
