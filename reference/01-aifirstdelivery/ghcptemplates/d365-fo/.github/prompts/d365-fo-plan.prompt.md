---
mode: agent
description: "Generate a D365 F&O implementation plan (object-level tasks) from an approved TDD. Triggers on: 'plan', 'implementation plan', 'create plan'."
---
...
Run /d365-fo-tdd-review {requirement-name} and resolve all BLOCKERs before generating the plan.
```
...
Next step: /d365-fo-plan-review {requirement-name}
```
