---
mode: agent
description: "Generate D365 F&O operational documentation — deployment guide, release notes, test evidence. Triggers on: 'document', 'operational docs', 'post-implementation docs'."
---
...
```
/d365-fo-document {requirement-name}
```
