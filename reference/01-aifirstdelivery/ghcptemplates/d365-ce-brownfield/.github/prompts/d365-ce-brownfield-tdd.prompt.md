---
mode: agent
description: "Generate the technical overview (TDD) covering architecture patterns, tech debt, risks, and developer event traces. Triggers on: 'tdd', 'technical overview', 'technical summary'."
---
...
Next step: /d365-ce-brownfield-blueprint
```
