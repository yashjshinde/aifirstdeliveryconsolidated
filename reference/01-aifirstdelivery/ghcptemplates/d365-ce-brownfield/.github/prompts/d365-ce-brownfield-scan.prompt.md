---
mode: agent
description: "Scan all D365 CE solution artefacts and build the component inventory. Must run before any document command. Triggers on: 'scan', 'component inventory', 'discover components'."
---

# /d365-ce-brownfield-scan — Discover and Catalogue All Project Components
...
Suggested next steps:
  /d365-ce-brownfield-document all          — generate all component documentation (includes adf + reporting)
  /d365-ce-brownfield-document adf          — ADF pipeline documentation only
  /d365-ce-brownfield-document reporting    — SSRS and Power BI documentation only
