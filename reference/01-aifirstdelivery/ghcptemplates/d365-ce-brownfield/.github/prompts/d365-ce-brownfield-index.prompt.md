---
mode: agent
description: "Generate the master navigation index linking all generated documents. Triggers on: 'index', 'navigation index', 'generate index'."
---
...
```
/d365-ce-brownfield-index
```

## Pre-condition Check

Check `docs-generated/component-inventory.md` exists.
If not, stop: "Run `/d365-ce-brownfield-scan` first."
...
- [ ] {scope} — run `/d365-ce-brownfield-document {scope}` to generate
```
