---
mode: agent
description: "Generate the functional overview (FDD) synthesising all documented components into business language. Triggers on: 'fdd', 'functional overview', 'business summary'."
---
...
Next steps: /d365-ce-brownfield-tdd  |  /d365-ce-brownfield-blueprint  |  /d365-ce-brownfield-index
```
