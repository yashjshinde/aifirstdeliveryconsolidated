---
mode: agent
description: "Review a solution blueprint for completeness, mandatory diagrams, and cross-platform pattern compliance. Triggers on: 'solution-review', 'review blueprint', 'validate blueprint'."
---
...
Run /solution-architect-solution-blueprint {project-name} first.
```
...
author: Claude Code (/solution-architect-solution-review)
---
