---
mode: agent
description: "Generate an Azure Integration Functional Design Document. Triggers on: 'fdd', 'functional design'."
---
...
1. Read `specs/{feature-name}/review.md`. If status is not `APPROVED`, stop: "Run /integration-review first and resolve all BLOCKERs before generating the FDD."
