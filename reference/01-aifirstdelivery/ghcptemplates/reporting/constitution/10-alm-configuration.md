...
# ── Requirement Intake ────────────────────────────────────────────────────────
requirement-intake: unstructured    # unstructured | structured

# ── L3 Intake (only applies when requirement-intake: structured) ──────────────
l3-intake: required                 # required | optional
...
# Path is relative to this template's root directory (ghcptemplates/reporting/).
# Default assumes reporting and brownfield agents are sibling folders under ghcptemplates/.
brownfield:
  enabled: false
