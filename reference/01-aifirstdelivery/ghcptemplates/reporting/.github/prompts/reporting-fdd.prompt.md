---
mode: agent
description: "Generate a Reporting Functional Design Document. Triggers on: 'fdd', 'functional design'."
---
...
```
/reporting-fdd {feature-name}
```

## Pre-condition Check

1. Read `specs/{feature-name}/review.md`.
2. If status is not `APPROVED`, stop: "Run /reporting-review first and resolve all BLOCKERs before generating the FDD."
...
Next step: /reporting-testplan {feature-name}  or  /reporting-plan {feature-name}
```
