---
mode: agent
description: "Generate a Reporting solution blueprint. Triggers on: 'blueprint', 'solution blueprint'."
---
...
```
/reporting-blueprint {feature-name}
```

## Pre-condition Check

1. Read `plans/{feature-name}/clarify.md`.
2. If status is not `TASK-READY` or `PARTIALLY READY`, stop: "Run /reporting-clarify first. Blueprint requires a reviewed plan."
