---
mode: agent
description: "Generate dev-ready task cards from a task-ready Reporting plan. Triggers on: 'task', 'task cards'."
---
...
Total: {N} task cards
Next step: /reporting-validate {feature-name}
```
