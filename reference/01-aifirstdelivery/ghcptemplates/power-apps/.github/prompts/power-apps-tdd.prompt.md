---
mode: agent
description: "Generate a Technical Design Document for a Power Platform feature covering Dataverse schema, Canvas App, flows, Copilot, and security design. Triggers on: 'tdd', 'technical design', 'design document'."
---
