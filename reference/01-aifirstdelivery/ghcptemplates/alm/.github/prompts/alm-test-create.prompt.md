---
mode: agent
description: "Bulk-create a full Azure DevOps test hierarchy (Test Plan + Suites + Cases) from a domain agent test extract. Triggers on: 'create test plan', 'create test cases in ADO', 'test-create'."
---
...
```
/alm-test-create {domain} {feature}
/alm-test-create {domain} {feature} --dry-run
```
...
Run /alm-test-create {domain} {feature} to create in ADO.
```
...
### 8. Auto-sync
Automatically run `/alm-test-sync {domain} {feature}`.
