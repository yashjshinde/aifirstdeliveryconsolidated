---
mode: agent
description: "Push a local document to an Azure DevOps Wiki page (create or update). Triggers on: 'push to wiki', 'upload to wiki', 'wiki-push'."
---
...
```
/alm-wiki-push {domain} {feature} {doc}
```
