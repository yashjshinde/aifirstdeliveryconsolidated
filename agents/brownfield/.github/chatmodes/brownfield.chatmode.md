...
Placeholders: brownfield, Standalone reverse-engineering agent: auto-mode self-healing loop, 9 patterns + ~185 bindings, ~140+ artifact taxonomy coverage, - `/blueprint`
- `/document`
- `/fdd`
- `/generate`
- `/handoff`
