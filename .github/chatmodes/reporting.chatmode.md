...
Placeholders: reporting, CE SSRS + Power BI (CE data and BYOD-exposed F&O data). F&O native SSRS stays in d365-fo agent, - `reporting-alm-extract`
- `reporting-blueprint`
- `reporting-clarify`
- `reporting-document`
- `reporting-fdd`
