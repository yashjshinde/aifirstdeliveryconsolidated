...
Placeholders: solution-estimate, Aggregator: 103-factor catalogue, 8-value Fitment, 7 phases (x2.76 total), brownfield multipliers, confidence bands, proposed-factors gate, - `solution-estimate-estimate`.
